...
map.getView().fit([11556515.538790, -532124.239171, 11713481.238910, -385240.710232], map.getSize());
...
function createPopupField(currentFeature, currentFeatureKeys, layer) {
    ...
    popupField += (fieldValue != null ? '<img src="' + fieldValue + '" style="width:100%;max-width:350px;border-radius:8px;" onerror="this.style.display=\'none\'" /></td>' : '');
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Integrasi Data Kemiskinan dan Stunting</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (516 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Dataset ini menampilkan sebaran kecamatan yang menjadi wilayah prioritas intervensi kemiskinan dan stunting di Kabupaten OKU Timur, hasil integrasi dari data kemiskinan serta data stunting. Data ini digunakan untuk analisis irisan sasaran kemiskinan dan stunting antar kecamatan, identifikasi wilayah yang membutuhkan penanganan prioritas, serta perencanaan program penanggulangan kemiskinan dan percepatan penurunan stunting secara terpadu dan tepat sasaran. Sumber: DTSEN, E-PPGBM, dan ELSIMIL Kabupaten OKU Timur.';
            }
